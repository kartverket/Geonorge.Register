...
namespace Kartverket.Register.Controllers
{
    public class ApiRootController : ApiController
    {
        ...
        /// </summary>
        /// <remarks>
        /// Med GeoLett skal vi forbedre datagrunnlaget for plan- og byggesaksprosessen. Det gj�r vi ved � fremme innovasjon av metodebruk og digitale verkt�y, legge til rette for effektiv deling av informasjon og st�tte kommuner og sektormyndigheter for � forbedre kvaliteten p� grunndata.
        /// </remarks>
        /// <returns></returns>
