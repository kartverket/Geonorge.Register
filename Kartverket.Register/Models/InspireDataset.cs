...
namespace Kartverket.Register.Models
{
    public class InspireDataset : DatasetV2
    {
        ...
        //Metadat service
        [ForeignKey("InspireDeliveryMetadataService"), Required, Display(Name = "MetadataServiceStatus", ResourceType = typeof(InspireDataSet))]
        ...
        //Distribution
        [ForeignKey("InspireDeliveryDistribution"), Required, Display(Name = "Distribution", ResourceType = typeof(InspireDataSet))]
        ...
        //WFS
        [ForeignKey("InspireDeliveryWfs"), Required, Display(Name = "WfsStatus", ResourceType = typeof(InspireDataSet))]
        public Guid InspireDeliveryWfsId { get; set; }
        public virtual DatasetDelivery InspireDeliveryWfs { get; set; }

        //Atom-feed
        [ForeignKey("InspireDeliveryAtomFeed"), Required, Display(Name = "AtomFeedStatus", ResourceType = typeof(InspireDataSet))]
        public Guid InspireDeliveryAtomFeedId { get; set; }
        public virtual DatasetDelivery InspireDeliveryAtomFeed { get; set; }

        //Atom or WFS
        [ForeignKey("InspireDeliveryWfsOrAtom"), Required, Display(Name = "WfsOrAtomStatus", ResourceType = typeof(InspireDataSet))]
        public Guid InspireDeliveryWfsOrAtomId { get; set; }
        public virtual DatasetDelivery InspireDeliveryWfsOrAtom { get; set; }

        //Harmonized data
        [ForeignKey("InspireDeliveryHarmonizedData"), Required, Display(Name = "HarmonizedDataStatus", ResourceType = typeof(InspireDataSet))]
        ...
        [ForeignKey("InspireDeliverySpatialDataService"), Required, Display(Name = "SpatialDataServiceStatus", ResourceType = typeof(InspireDataSet))]
        ...
        [Display(Name = "Area", ResourceType = typeof(InspireDataSet))]
        public int Area { get; set; }
        [Display(Name = "RelevantArea", ResourceType = typeof(InspireDataSet))]
