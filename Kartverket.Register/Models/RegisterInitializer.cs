...
{
    public class RegisterInitializer: DropCreateDatabaseIfModelChanges<RegisterDbContext>
    {
        protected override void Seed(Kartverket.Register.Models.RegisterDbContext context)
        {
            ...
            context.Organizations.AddOrUpdate(
                new Organization { systemId = Guid.Parse("CEB5E459-853E-4E2F-BB22-39DC0C09CB7B"), registerId = Guid.Parse("FCB0685D-24EB-4156-9AC8-25FA30759094"), dateSubmitted = DateTime.Now, modified = DateTime.Now, number = "874783242", name = "Kystverket", logoFilename = "http://register.test.geonorge.no/data/organizations/874783242_kystverketlogo.jpg" },
                new Organization { systemId = Guid.Parse("D7142A92-418E-487E-A6FF-0E32C6AE31D8"), registerId = Guid.Parse("FCB0685D-24EB-4156-9AC8-25FA30759094"), dateSubmitted = DateTime.Now, modified = DateTime.Now, number = "970188290", name = "Norges geologiske undersøkelse", logoFilename = "http://register.test.geonorge.no/data/organizations/970188290_nguLogo.png" },
                new Organization { systemId = Guid.Parse("10087020-F17C-45E1-8542-02ACBCF3D8A3"), registerId = Guid.Parse("FCB0685D-24EB-4156-9AC8-25FA30759094"), dateSubmitted = DateTime.Now, modified = DateTime.Now, number = "874783242", name = "Kartverket", logoFilename = "http://register.test.geonorge.no/data/organizations/971040238_kartverket_logo.png" },
                new Organization { systemId = Guid.Parse("DD34C8CA-5E5C-4CFD-9B25-AFEADD1BCBFF"), registerId = Guid.Parse("FCB0685D-24EB-4156-9AC8-25FA30759094"), dateSubmitted = DateTime.Now, modified = DateTime.Now, number = "999601391", name = "Miljødirektoratet", logoFilename = "http://register.test.geonorge.no/data/organizations/999601391_miljodirlogo.JPG" }
            );
           
            //context.Registers.AddOrUpdate(
            //     new Register { systemId = Guid.Parse("A42BC2B3-2314-4B7E-8007-71D9B10F2C04"), name = "Produktark", ownerId = Guid.Parse("10087020-F17C-45E1-8542-02ACBCF3D8A3") }
