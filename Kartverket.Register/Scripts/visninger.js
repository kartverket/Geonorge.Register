...
function tableView() {
    ...
    $('.search-results.epsg').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-title'><h4>" + sLink("Tittel", "name") + "</h4></div><div class='col-actions'><h4>" + sLink("EPSG", "epsg") + "</h4><h4>" + sLink("Sosi ref. system", "sosiReferencesystem") + "</h4><h4>Ekstern ref.</h4></div><div class='col-actions'><h4>Inspire krav</h4><h4>Nasjonalt krav</h4><h4>Nasjonalt krav for havområder</h4></div></div></div>");
