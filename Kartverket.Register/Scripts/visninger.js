...
function tableView()
 {
    ...
    $('.search-results.organization').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-title'><h4>Organisasjonsnavn</h4><h4>Organisasjonsnummer</h4></div><div class='space'>.</div><div class='col-actions'><h4>Status</h4></div></div>");
    ...
    $('.search-results.dataset').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-title'><h4>Tittel</h4><h4>Eier</h4></div><div class='col-actions'>Data</div><div class='col-information'><h4>SOSI</h4><h4>WMS</h4><h4>Status</h4><h4>Temagruppe</h4></div></div></div>");
