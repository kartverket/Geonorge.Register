...
function addTableHeading() {
    ...
    $('.search-results.document').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-title'><h4>" + sLink(Title_Resource, "name") + "</h4><h4>" + sLink(Document_Owner_Resource, "documentOwner") + "</h4></div><div class='space'>&nbsp;</div><div class='col-actions'><h4>" + sLink("Status", "status") + "</h4></div></div>");
    ...
    $('.search-results.namespace').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-title'><h4>" + sLink(Namespace_NamespaceName_Resource, "name") + "</h4></div><div class='col-information'><h4>" + sLink(Namespace_Etat_Resource, "submitter") + "</h4></div><div class='col-descripton'><h4>" + Namespace_Content_Resource + "</h4></div><div class='col-actions'><h4>" + Namespace_Service_Resource + "</h4></div></div>");
