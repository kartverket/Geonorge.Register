...
function tableView() {
    ...
    $('.search-results.epsg').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-title'><h4>" + sLink("Tittel", "name") + "</h4></div><div class='col-actions'><h4>" + sLink("EPSG", "epsg") + "</h4><h4>" + sLink("Sosi ref. system", "sosiReferencesystem") + "</h4><h4>Ekstern ref.</h4></div><div class='col-actions'><h4>" + sLink("Inspire krav", "inspireRequirement") + "</h4><h4>" + sLink("Nasjonalt krav", "nationalRequirement") + "</h4><h4>" + sLink("Nasjonalt krav for havområder", "nationalSeasRequirement") + "</h4></div></div></div>");
