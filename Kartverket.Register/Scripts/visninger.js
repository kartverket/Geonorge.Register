...
function addTableHeading() {
    ...
    $('.search-results.serviceAlert').prepend("<div class='clearfix'></div><div class='table-heading'><div class='col-date'><h4>" + sLink("Siste varsel", "alertdate") + "</h4><h4>" + sLink("Ikrafttredelse", "effectivedate") + "</h4></div><div class='col-information'><h4>" + sLink(Owner_Resource, "owner") + "</h4><h4>" + sLink("Type varsel", "servicealert") + "</h4><h4>" + sLink("Tjenestetype", "servicetype") + "</h4></div><div class='col-title'><h4>" + sLink("Tjenestenavn", "name") + "</h4></div><div class='col-description'><h4>" + Description_Resource + "</h4></div></div>");
}
