...
namespace Kartverket.Register.Services.Register
{
    public class RegisterService : IRegisterService
    {
        ...
        public RegisterGrouped GetRegistersGrouped()
        {
            ...
            registers.Add(new RegisterView { name = "Planguider", description = "I dette registeret kan du gå inn og opprette eller endre arealplanveiledningstekster, samt se en oversikt over eksisterende arealplanveiledere.", ExternalUrl = "/geolett" });
